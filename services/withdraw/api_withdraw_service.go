...
func (a *APIWithdrawService) GetWithdrawals(ctx context.Context, req WithdrawalsReq) (resp *[]map[string]interface{}, result *core.APIResult, err error) {
	var (
		localVarHTTPMethod   = nethttp.MethodGet
		localVarPostBody     interface{}
		localVarQueryParams  neturl.Values
	...
	localVarPath := core.DefaultEndpoint + "/v1/pay/wallet/withdrawals"
	localVarQueryParams = neturl.Values{}
	localVarQueryParams.Add("currency", req.Currency)
